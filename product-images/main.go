...
import (
	...
	"github.com/annbelievable/nicholas_jackson_microservice_guide/product-images/files"
	"github.com/annbelievable/nicholas_jackson_microservice_guide/product-images/handlers"
...
func main() {
	...
	// problem with the FileServer is that it is dumb
